...
const CLIENTS = [
  { name: "VTU CPGS", icon: Hexagon },
  { name: "Kalaburagi", icon: Triangle },
  { name: "MSME Certified", icon: Command },
  { name: "100% Placement", icon: Ghost },
  { name: "IEEE Projects", icon: Gem },
  { name: "Live Training", icon: Cpu },
];
...
export default function HeroSection({ stats }) {
  const projectTotal = stats?.project_total || "75+";
  const internshipTotal = stats?.internship_total || "10+";
  ...
  return (
    <div className="relative w-full bg-zinc-950 text-white overflow-hidden font-sans">
      ...
      <div
        ...
        style={{
          backgroundImage: "url(https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=1600&q=80)",
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            <div className="animate-fade-in delay-100">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 backdrop-blur-md transition-colors hover:bg-white/10">
                <span className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-zinc-300 flex items-center gap-2">
                  MSME Registered · Kalaburagi, Karnataka
            ...
            <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
              Vignan TechSolutions bridges the gap between education and employment — through hands-on internships, industry courses, real-time projects, and corporate training.
            </p>
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <div className="text-3xl font-bold tracking-tight text-white">{projectTotal}</div>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-400">Student Satisfaction</span>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <StatItem value={internshipTotal} label="Internships" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-8 backdrop-blur-xl">
              <h3 className="mb-6 px-8 text-sm font-medium text-zinc-400">Trusted by Students & Institutions</h3>
